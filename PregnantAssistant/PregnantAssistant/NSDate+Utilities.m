...
+ (NSDate *)dateWithWeeksFromDate:(NSDate *)date weeks:(NSInteger)weeks{
    
    NSTimeInterval aTimeInterval = [date timeIntervalSinceReferenceDate] + D_WEEK * weeks;
    NSDate *newDate = [NSDate dateWithTimeIntervalSinceReferenceDate:aTimeInterval];
    return newDate;
}
...
- (BOOL) isSameDayMonthYearsAdDate: (NSDate *)aDate
{
    NSDateComponents *components1 = [[NSDate currentCalendar] components:NSYearCalendarUnit | NSMonthCalendarUnit |NSDayCalendarUnit fromDate:self];
    NSDateComponents *components2 = [[NSDate currentCalendar] components:NSYearCalendarUnit | NSMonthCalendarUnit|NSDayCalendarUnit fromDate:aDate];
    return ((components1.month == components2.month) &&
...
{
    NSDateComponents *components1 = [[NSDate currentCalendar] components:NSDayCalendarUnit fromDate:self];
    NSDateComponents *components2 = [[NSDate currentCalendar] components:NSDayCalendarUnit fromDate:aDate];
...
- (NSInteger)distanceInDaysToDate:(NSDate *)anotherDate
{
    ...
    NSDateComponents *comps2 = [cal2 components:unitFlags fromDate:anotherDate];
...
{
    NSInteger unitFlags = NSMinuteCalendarUnit|NSHourCalendarUnit|NSDayCalendarUnit| NSMonthCalendarUnit | NSYearCalendarUnit;
    NSCalendar *cal = [[NSCalendar alloc] initWithCalendarIdentifier:NSGregorianCalendar];
    NSDateComponents *comps = [cal components:unitFlags fromDate:self];
    NSDate *newBegin  = [cal dateFromComponents:comps];
    ...
    NSTimeInterval interval = [newEnd timeIntervalSinceDate:newBegin];
    NSInteger beginMinutes=((NSInteger)interval)/D_MINUTE;
    NSLog(@"ilskdjfksjdkflsdkf: %d",beginMinutes);
    return beginMinutes;
    
}


- (NSInteger)distanceMonthToDate:(NSDate *)anotherDate{
...
- (NSInteger)distanceBesideMonthDaysToDate:(NSDate *)anotherDate
{
    NSCalendar *gregorianCalendar = [[NSCalendar alloc] initWithCalendarIdentifier:NSGregorianCalendar];
    NSDateComponents *components = [gregorianCalendar components:NSDayCalendarUnit|NSMonthCalendarUnit fromDate:self toDate:anotherDate options:0];
