...
//        CGFloat borderWidth = 200;
//        _cropperView.frame = CGRectInset(_cropperView.frame, -borderWidth, -borderWidth);
        
//        _cropperView.layer.backgroundColor = [UIColor blackColor].CGColor;
        _cropperView.layer.borderColor = [UIColor whiteColor].CGColor;
        _cropperView.layer.borderWidth = 1.5;
        _cropperView.alpha = 0.8;
        
        UIView *shadowView = [[UIView alloc]initWithFrame:_cropRect];
        shadowView.frame = CGRectInset(shadowView.frame, -280, -280);

        shadowView.layer.borderColor = [UIColor blackColor].CGColor;
        shadowView.layer.borderWidth = 280;
