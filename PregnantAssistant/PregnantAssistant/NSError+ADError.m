...
+ (NSError *)notLoginError
{
    ...
    return [NSError errorWithDomain:@"com.addinghome.pa" code:ERRCODE_NOTLOGIN userInfo:userInfo];
}

+ (NSError *)lessToolError
{
    NSDictionary *userInfo = @{ NSLocalizedDescriptionKey:@"less 6 tool" };
    return [NSError errorWithDomain:@"com.addinghome.pa" code:ERRCODE_LESS_TOOL userInfo:userInfo];
}
